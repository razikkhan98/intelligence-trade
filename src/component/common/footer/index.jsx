		...
		<div className="container">
			<div className="row">
				<div className="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-1 order-lg-4 order-xl-1">
					...
					{/* <!-- footer tagline --> */}
					<p className="footer__tagline">The Centure team works hard <br/>to deliver exceptional financial results <br/>and increase our clients' revenue.</p>
					{/* <!-- end footer tagline --> */}
				...
				<div className="col-12">
					<div className="footer__content">
						...
						<div className="footer__social">
							<a href="#" target="_blank"><i className="ti ti-brand-facebook"></i></a>
							<a href="#" target="_blank"><i className="ti ti-brand-x"></i></a>
							<a href="#" target="_blank"><i className="ti ti-brand-instagram"></i></a>
							<a href="#" target="_blank"><i className="ti ti-brand-telegram"></i></a>
							<a href="#" target="_blank"><i className="ti ti-brand-discord"></i></a>
							<a href="#" target="_blank"><i className="ti ti-brand-linkedin"></i></a>
						</div>
						{/* <!-- end footer social --> */}

						{/* <!-- footer copyright --> */}
						<small className="footer__copyright">© Centure, 2023. Created by <a href="https://themeforest.net/user/dmitryvolkov/portfolio" target="_blank">Dmitry Volkov</a>.</small>
